                ...
                <div class="card-body">
                    ...
                    <form class="row" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 col-lg-6">
                            ...
                            <input type="text" class="form-control" readonly name="program" value="<?php echo $data['program']; ?>" id="program" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3 col-lg-6">
                            <label for="rollno" class="form-label">Roll NO.</label>
                            <input type="number" class="form-control" readonly name="rollno" value="<?php echo $data['rollno']; ?>" id="rollno" aria-describedby="emailHelp">
                        </div>
